...
# Baca dua gambar
image1 = cv2.imread('canny-edge/canny_with_opencv.jpg')
image2 = cv2.imread('canny-edge/laplacian_with_opencv.jpg')
image3 = cv2.imread('canny-edge/sobel_with_opencv.jpg')
...
cv2.imwrite('canny-edge/combined_image.jpg', comb_img)
